...
CBarkeeperNPC::CBarkeeperNPC(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{

}

CBarkeeperNPC::CBarkeeperNPC(const CBarkeeperNPC& rhs)
	: CGameObject(rhs)
{

}

CBarkeeperNPC::~CBarkeeperNPC(void)
{

}

HRESULT CBarkeeperNPC::Ready_Object(void)
{
...
Engine::_int CBarkeeperNPC::Update_Object(const _float& fTimeDelta)
{
...
void CBarkeeperNPC::Render_Object(void)
{
...
HRESULT CBarkeeperNPC::Add_Component(void)
{
	CComponent*			pComponent = nullptr;

	// DynamicMesh
	pComponent = m_pMeshCom = dynamic_cast<CDynamicMesh*>(Clone_Proto(L"Proto_Mesh_BarkeeperFemale"));
...
void CBarkeeperNPC::Key_Input(const _float& fTimeDelta)
{
...
//		m_pMeshCom->Set_AnimationIndex(8);
	...
	//}
		...
		//m_pTransformCom = dynamic_cast<CTransform*>(Engine::Get_Component(L"GameLogic", OBJECT_BarkeeperNPC, L"Com_Transform", ID_DYNAMIC));
...
_float CBarkeeperNPC::SetUp_OnTerrain(void)
{
	_vec3	vPos;
	m_pTransformCom->Get_Info(INFO_POS, &vPos);
...
Engine::_vec3 CBarkeeperNPC::PickUp_OnTerrain(void)
{
	CTerrainTex*		pTerrainBufferCom = dynamic_cast<CTerrainTex*>(Engine::Get_Component(L"GameLogic", OBJECT_TERRAIN, L"Com_Buffer", ID_STATIC));
...
CBarkeeperNPC* CBarkeeperNPC::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CBarkeeperNPC*	pInstance = new CBarkeeperNPC(pGraphicDev);
