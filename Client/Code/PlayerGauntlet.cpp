...
CPlayerGauntlet::CPlayerGauntlet(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{

}

CPlayerGauntlet::CPlayerGauntlet(const CPlayerGauntlet& rhs)
	: CGameObject(rhs)
{

}

CPlayerGauntlet::~CPlayerGauntlet(void)
{

}

HRESULT CPlayerGauntlet::Ready_Object(void)
{
...
Engine::_int CPlayerGauntlet::Update_Object(const _float& fTimeDelta)
{
	_vec3 vDir, vPos;
	...
	if (dynamic_cast<CPlayer*>(m_pPlayer)->Get_ArmEquip() && !dynamic_cast<CPlayer*>(m_pPlayer)->Get_ArmorFullEquip())
	{
...
void CPlayerGauntlet::Render_Object(void)
{
	if (dynamic_cast<CPlayer*>(m_pPlayer)->Get_ArmEquip() && !dynamic_cast<CPlayer*>(m_pPlayer)->Get_ArmorFullEquip())
	{
...
HRESULT CPlayerGauntlet::Add_Component(void)
{
	CComponent*			pComponent = nullptr;

	// StaticMesh
	pComponent = m_pMeshCom = dynamic_cast<CDynamicMesh*>(Clone_Proto(L"Proto_Mesh_HideGauntlet"));
...
Engine::_bool CPlayerGauntlet::Collision_ToObject(const _tchar* pLayerTag, const OBJECT_ID pObjTag)
{
...
CPlayerGauntlet* CPlayerGauntlet::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CPlayerGauntlet*	pInstance = new CPlayerGauntlet(pGraphicDev);
...
void CPlayerGauntlet::Free(void)
{
	CGameObject::Free();
}
