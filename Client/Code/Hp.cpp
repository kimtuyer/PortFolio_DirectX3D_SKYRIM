...
Engine::_int CHp::Update_Object(const _float& fTimeDelta)
{
	if (m_bRender)
	{
	...
	//Add_RenderGroup(RENDER_Hp, this);
...
HRESULT CHp::Add_Component(void)
{
	...
	// texture
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Clone_Proto(L"Proto_Texture_HPBar"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
