...
CPlayerBoots::CPlayerBoots(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{

}

CPlayerBoots::CPlayerBoots(const CPlayerBoots& rhs)
	: CGameObject(rhs)
{

}

CPlayerBoots::~CPlayerBoots(void)
{

}

HRESULT CPlayerBoots::Ready_Object(void)
{
...
Engine::_int CPlayerBoots::Update_Object(const _float& fTimeDelta)
{
	_vec3 vDir, vPos;
	...
	if (dynamic_cast<CPlayer*>(m_pPlayer)->Get_BootsEquip() && !dynamic_cast<CPlayer*>(m_pPlayer)->Get_ArmorFullEquip())
	{
...
void CPlayerBoots::Render_Object(void)
{
	if (dynamic_cast<CPlayer*>(m_pPlayer)->Get_BootsEquip() && !dynamic_cast<CPlayer*>(m_pPlayer)->Get_ArmorFullEquip())
	{
...
HRESULT CPlayerBoots::Add_Component(void)
{
	CComponent*			pComponent = nullptr;

	// StaticMesh
	pComponent = m_pMeshCom = dynamic_cast<CDynamicMesh*>(Clone_Proto(L"Proto_Mesh_HideBoots"));
...
Engine::_bool CPlayerBoots::Collision_ToObject(const _tchar* pLayerTag, const OBJECT_ID pObjTag)
{
...
CPlayerBoots* CPlayerBoots::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CPlayerBoots*	pInstance = new CPlayerBoots(pGraphicDev);
