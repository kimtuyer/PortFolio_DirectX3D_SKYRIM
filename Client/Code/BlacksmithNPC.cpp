...
CBlacksmithNPC::CBlacksmithNPC(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{

}

CBlacksmithNPC::CBlacksmithNPC(const CBlacksmithNPC& rhs)
	: CGameObject(rhs)
{

}

CBlacksmithNPC::~CBlacksmithNPC(void)
{

}

HRESULT CBlacksmithNPC::Ready_Object(void)
{
...
Engine::_int CBlacksmithNPC::Update_Object(const _float& fTimeDelta)
{
...
void CBlacksmithNPC::Render_Object(void)
{
...
HRESULT CBlacksmithNPC::Add_Component(void)
{
	CComponent*			pComponent = nullptr;

	// DynamicMesh
	pComponent = m_pMeshCom = dynamic_cast<CDynamicMesh*>(Clone_Proto(L"Proto_Mesh_BlackSmith"));
...
void CBlacksmithNPC::Key_Input(const _float& fTimeDelta)
{
...
//		m_pMeshCom->Set_AnimationIndex(8);
	...
	//}
		...
		//m_pTransformCom = dynamic_cast<CTransform*>(Engine::Get_Component(L"GameLogic", OBJECT_BlacksmithNPC, L"Com_Transform", ID_DYNAMIC));
...
_float CBlacksmithNPC::SetUp_OnTerrain(void)
{
	_vec3	vPos;
	m_pTransformCom->Get_Info(INFO_POS, &vPos);
...
Engine::_vec3 CBlacksmithNPC::PickUp_OnTerrain(void)
{
	CTerrainTex*		pTerrainBufferCom = dynamic_cast<CTerrainTex*>(Engine::Get_Component(L"GameLogic", OBJECT_TERRAIN, L"Com_Buffer", ID_STATIC));
...
CBlacksmithNPC* CBlacksmithNPC::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CBlacksmithNPC*	pInstance = new CBlacksmithNPC(pGraphicDev);
