...
BEGIN_MESSAGE_MAP(CAboutDlg, CDialogEx)
	ON_LBN_SELCHANGE(IDC_LIST2, &CAboutDlg::OnLbnSelchangeStaticList)
END_MESSAGE_MAP()
...
BOOL CMFCApplication1App::OnIdle(LONG lCount)
{
	...
	CMainFrame* pMainFrame = dynamic_cast<CMainFrame*>(GetMainWnd());
...
int CMFCApplication1App::Update()
{
	return 0;
}


void CAboutDlg::OnLbnSelchangeStaticList()
{
